...
def main():
    ...
    dataset = MoleculeDataset("../finetune/dataset/" + args.dataset, dataset=args.dataset, transform = ExtractSubstructureContextPair(args.num_layer, l1, l2))
    ...
    if not args.input_model_file == "":
        model_substruct.load_state_dict(torch.load(args.input_model_file + ".pth"))
