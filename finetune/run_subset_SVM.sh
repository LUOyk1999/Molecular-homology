...
do
# python finetune_subset.py --input_model_file ../pretrain_PI/${model_file}.pth --split $split --runseed $runseed --gnn_type gin --dataset bace --epoch 100 --threshold $threshold 
