...
def main():
    ...
    #set up dataset
    dataset = MoleculeDataset(f"{args.dir_data}/{args.dataset}", dataset=args.dataset)

    print(dataset)
    
    if args.split == "scaffold":
        smiles_list = pd.read_csv(f"{args.dir_data}/{args.dataset}/processed/smiles.csv", header=None)[0].tolist()
